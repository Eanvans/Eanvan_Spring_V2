...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/md5.min.js" type="text/javascript" charset="utf-8"></script>
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <c:choose>
                ...
                <c:when test="${not empty login}">
                    <form action="/login" class="login100-form validate-form" method="post" id="loginForm" onsubmit="return checkLoginForm()">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="请输入密码">
                            <input class="input100" type="password" placeholder="请输入密码" id="inputPassword">
                            <input class="input100" name="password" id="encodingPassword" hidden>
                            <span class="focus-input100" data-symbol="&#xf190;"></span>
                        </div>
                        <label class="w-100 text-right"><input type="checkbox" name="remember">记住我</label>
                ...
                <c:otherwise>
                    <form action="/register" class="login100-form validate-form" method="post" id="registerForm" onsubmit="return encodingRegisterForm()">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="请输入密码">
                            <input class="input100" type="password" placeholder="请输入密码" id="password">
                            <input class="input100"  name="password" id="R_encoding_password" hidden>
                            <span class="focus-input100" data-symbol="&#xf190;"></span>
                        </div>
