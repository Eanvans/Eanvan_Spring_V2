...
<div class="container EHomeBlock p-t-20">
    <div class="row">
        ...
        <div class="float-right text-center col-md-4 bg-light">
            <h2 class="text-info">公告栏 >_<</h2>
            <div class="list-group">
                <c:forEach items="${annList}" var="anno" varStatus="s">
                    <a href="${anno.url}" class="list-group-item list-group-item-action">${anno.title}</a>
                </c:forEach>
            </div>
        </div>
    </div>
                ...
                <div class="card mb-4 shadow-sm">
                   <%-- <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <p>一定要有梦想，因为只有不断接近自己的梦想，努力接近的过程才有连续的动力！</p>
                        </div>
